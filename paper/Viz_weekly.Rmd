...
```{r plot, results="asis"}
if(is_html_output()){cat("<script src='https://cdnjs.cloudflare.com/ajax/libs/d3/4.5.0/d3.js'></script><script src='https://cdnjs.cloudflare.com/ajax/libs/d3-queue/3.0.3/d3-queue.js'></script><br><br><div class='figure'><div id='play'><button class='play-button'>Play</button></div><br><br><div id='plot'></div><p class='caption'>(\\#fig:residint1)Interactive plot of model residuals by date</p></div><br><br><script src='vis2.js'></script><script>do_polar('mod2.csv','#plot','#play','.play-button')</script>")}
```
...
# Acknowledgments {-}
This work was supported by the ESRC Centre for Population Change - phase II (grant ES/K007394/1). Many thanks to all the participants at the Rostock Retreat on Visualisation who provided helpful comments and questions on early versions of the work. All the views presented in this paper are those of the author only.
